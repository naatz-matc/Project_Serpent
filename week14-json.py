...
#This line retrieves the json data from the manually entered IP Address represented by {sys.argv[2]} from the  WebAPI
json_raw = requests.get(f'http://ipinfo.io/{sys.argv[2]}/json')
